...
def absensiWajah():
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            ...
            id2, confidence = faceRecognizer.predict(abuabu[y:y+h,x:x+w])
            id = id2
            if (confidence < 100):
                id = names[0]
...
canvas.configure(bg="#645CBB")
# judul
judul = tk.Label(root, text="Face Attendance - Smart Absensi", font=("Roboto",34), bg ="#645CBB", fg="white")
...
label1 = tk.Label(root, text="Nama Siswa", font="Roboto", fg="White", bg ="#645CBB")
...
label2 = tk.Label(root, text="NIM", font="Roboto", fg="white", bg ="#645CBB")
...
label3 = tk.Label(root, text="Kelas", font="Roboto", fg="white", bg ="#645CBB")
canvas.create_window(65, 250, window=label3)

global intructions

# tombol untuk rekam data wajah
intructions = tk.Label(root, text="Welcome", font=("Roboto",15),fg="White",bg="#645CBB")
