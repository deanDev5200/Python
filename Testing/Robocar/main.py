        ...
        if hands:
            ...
            if lmList:
                ...
                if fingers == [0, 1, 1, 0, 0] and i != 1:
                    requests.get('http://192.168.4.1/set?a=1', timeout=0.1)
                    i = 1
                elif fingers == [0, 0, 0, 0, 1] and i != 2:
                    requests.get('http://192.168.4.1/set?a=2', timeout=0.1)
                    i = 2
                elif fingers == [0, 1, 0, 0, 0] and i != 3:
                    requests.get('http://192.168.4.1/set?a=3', timeout=0.1)
                    i = 3
                elif fingers == [1, 0, 0, 0, 0] and i != 4:
                    requests.get('http://192.168.4.1/set?a=4', timeout=0.1)
                    i = 4
